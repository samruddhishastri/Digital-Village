...
import 'package:temp/Screens/ViewStatus/viewstatus.dart';
import 'dart:convert';
...
class _BodyState extends State<Body> {
  ...
  getData() async {
    var url = Uri.parse('http://20.62.249.138/api/view_complaints');
        ...
        child: Card(
            ...
            child: Column(children: <Widget>[
              ListTile(
                ...
                trailing: Text(req['category']),
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) {
                        return ViewStatusScreen(id: '${req['complaint_id']}');
                      },
                    ),
                  );
                },
